//
//  Cipher01 DetectorConstruction.cc
//
...
G4VPhysicalVolume* DetectorConstruction::ConstructPixel()
{
...
//void DetectorConstruction::SetCeramicMaterial(G4String materialChoice)
//{
  // search the material by its name
//  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);
//  if (pttoMaterial)
